...
extraction (zip, 7z, gzip, zstd, tar...).
  ...
  # libarchive sources are added: to enable the real backend on iOS, add the
  # libarchive + codec sources to source_files below and append
  # '-DARCHIVE_FFI_HAVE_LIBARCHIVE=1' to GCC_PREPROCESSOR_DEFINITIONS, then
  # vendor the sources per src/libarchive/PLACEHOLDER.md.
